...
from code.common.log_parser import extract_single_perf_result, extract_single_power_result, \
...
def get_sorted_perf_vals(perf_file_list, scenario):
    """
    ...
    scenario_criteria = {
        ...
        "Server": ("result_scheduled_samples_per_sec", SortingCriteria.Higher),
