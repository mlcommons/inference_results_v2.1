...
class KnownGPU(MatchableEnum):
    # TODO: Placeholder for GH100-PCIe gpus
    ...
    A10 = GPU(AliasedName("A10", ("NVIDIA A10",)),
              AcceleratorType.Discrete,
              match_float_approximate(Memory(22.48828125, ByteSuffix.GiB)),
              150.0,
...
class KnownCPU(MatchableEnum):
    Intel_Xeon_Platinum_8369B = CPU(AliasedName("Intel(R) Xeon(R) Platinum 8369B CPU @ 2.90GHz"),
                                   CPUArchitecture.x86_64, 16, MatchAllowList([1, 2, 4]))
    ...
    # TODO: Placeholder for GH100-pcie CPU
