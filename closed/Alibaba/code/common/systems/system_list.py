...
add_systems("A100_SXM_80GBx{}", "A100-SXM-80GBx{}",
            MatchAllowList([KnownCPU.Intel_Xeon_Platinum_8369B.value, KnownCPU.x86_64_Generic.value]),
...
add_systems("GeForceRTX_3090x{}", "GeForceRTX3090x{}", MATCH_ANY, KnownGPU.GeForceRTX_3090.value,
            [1], Memory(30, ByteSuffix.GiB))
add_systems("A10x{}", "A10x{}", KnownCPU.Intel_Xeon_Platinum_8369B.value, KnownGPU.A10.value,
