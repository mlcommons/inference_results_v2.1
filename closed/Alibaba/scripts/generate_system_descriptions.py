...
ORIN_AGX_02 = Machine(
    ...
    sw_notes="DLA loadable for resnet50 in offline scenario generated using preview compiler. Private harness code to run loadables. git hash: f23b7273986f02d3136673e5d18558c9a9d63799",
    system_id_prefix="",
...
ORIN_AGX_03 = Machine(
    ...
    accelerator_memory_configuration="SRAM",
    hw_notes="GPU and both DLAs are used in resnet50, ssd-mobilenet, and ssd-resnet34, in Offline scenario",
    sw_notes="DLA loadable for resnet50 and ssd-resnet34 in offline scenario generated using preview compiler. Private harness code to run loadables. git hash: f23b7273986f02d3136673e5d18558c9a9d63799",
    system_id_prefix="",
    system_name_prefix="NVIDIA Orin",
)
