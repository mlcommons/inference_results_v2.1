...
// biren settings
DEFINE_uint32(num_infer_streams, 1, "num_infer_streams");
DEFINE_uint32(num_complete_threads, 1, "num_complete_threads");
DEFINE_string(model_path, "", "the path to model to load");
DEFINE_bool(enable_packing, true, "Enable to pack data for inputs, this is valid for bert");
DEFINE_int32(max_packing_size, 3, "The max number of sequence to pack in one input sequence");
