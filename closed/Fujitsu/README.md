# MLPerf Inference v2.1 Fujitsu Implementations

Fujitsu uses the same code and implementations as in NVIDIA's environment. 
The following document is copied from the repository of NVIDIA-optimized implementations.
