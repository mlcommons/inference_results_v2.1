...
###############################
custom_systems['RX2540M6_A30x1_TRT'] = SystemConfiguration(host_cpu_conf=CPUConfiguration(layout={CPU(name="Intel(R) Xeon(R) Platinum 8352Y CPU @ 2.20GHz", architecture=CPUArchitecture.x86_64, core_count=32, threads_per_core=1): 2}), host_mem_conf=MemoryConfiguration(host_memory_capacity=Memory(quantity=263.863808, byte_suffix=ByteSuffix.GB), comparison_tolerance=0.05), accelerator_conf=AcceleratorConfiguration(layout={KnownGPU.A30.value: 1}), numa_conf=None, system_id="RX2540M6_A30x1_TRT")
