...
class KnownGPU(MatchableEnum):
    ...
    A100_SXM_80GB_RO = GPU(AliasedName("A100-SXM-80GB", ("NVIDIA A100-SXM-80GB", "NVIDIA A100-SXM4-80GB")),
                           ...
                           pci_id_match_list(("20B2",)),
                           80)
    A100_SXM_80GB_500 = GPU(AliasedName("A100-SXM-80GB", ("NVIDIA A100-SXM-80GB", "NVIDIA A100-SXM4-80GB")),
                        AcceleratorType.Discrete,
                        match_float_approximate(Memory(80, ByteSuffix.GiB)),
                        500.0,
                        pci_id_match_list(("20B2",)),
...
class KnownCPU(MatchableEnum):
    ...
    AMD_EPYC_7773X = CPU(AliasedName("AMD EPYC 7773X 64-Core Processor", ("AMD EPYC 7773X",)),
                        CPUArchitecture.x86_64, 64, MatchAllowList([1, 2]))
    ...
    Intel_Xeon_Platinum_8378A = CPU(AliasedName("Intel(R) Xeon(R) Platinum 8378A CPU @ 3.00GHz"),
