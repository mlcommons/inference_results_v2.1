...
class KnownGPU(MatchableEnum):
    ...
    A100_PCIe_80GB = GPU(AliasedName("A100-PCIe-80GB", ("NVIDIA A100-PCIe-80GB", "NVIDIA A100 80GB PCIe")),
                         ...
                         80)
    A100_SXM_40GB = GPU(AliasedName("A100-SXM4-40GB", ("NVIDIA A100-SXM4-40GB",)),
                         AcceleratorType.Discrete,
                         match_float_approximate(Memory(40, ByteSuffix.GiB)),
                         400.0,
...
class KnownMIG(MatchableEnum):
    ...
    A100_PCIe_80GB_1GPC = MIG(KnownGPU.A100_PCIe_80GB.value.name + " MIG-1g.10gb",
                              ...
                              80,
                              num_gpcs=1)
    A100_SXM_40GB_1GPC = MIG(KnownGPU.A100_SXM_40GB.value.name + " MIG-1g.5gb",
                              AcceleratorType.Discrete,
                              match_float_approximate(Memory(5, ByteSuffix.GiB)),
                              400.0,
                              pci_id_match_list(("20B0",)),
...
class KnownCPU(MatchableEnum):
    ...
    AMD_EPYC_7763 = CPU(AliasedName("AMD EPYC 7763 64-Core Processor", ("AMD EPYC 7763",)),
                        CPUArchitecture.x86_64, 64, MatchAllowList([1, 2]))
    AMD_EPYC_7543 = CPU(AliasedName("AMD EPYC 7543 32-Core Processor", ("AMD EPYC 7543",)),
                        CPUArchitecture.x86_64, 32, MatchAllowList([1, 2]))
