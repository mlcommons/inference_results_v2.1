...
# A100_PCIe_40GB and 80GB based systems:
add_systems("A100_PCIe_40GBx{}", "Apollo_6500_gen10_plus_A100-PCIe-40GBx{}", 
            MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.x86_64_Generic.value]),
            KnownGPU.A100_PCIe_40GB.value, [1, 2, 4, 8, 10], Memory(30, ByteSuffix.GiB))

# A100_SXM_40GB and SXM_80GB based systems:
add_systems("A100_SXM_40GBx{}", "Apollo_6500_gen10_plus_A100-SXM-40GBx{}",
            MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.x86_64_Generic.value]),
            KnownGPU.A100_SXM_40GB.value, [1, 4, 8], Memory(30, ByteSuffix.GiB))
add_systems("A100_SXM_80GBx{}", "Apollo_6500_gen10_plus_A100-SXM-80GBx{}",
            MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.x86_64_Generic.value]),
...
add_systems("A100_SXM_40GB_MIG_{}x1g_5gb", "Apollo_6500_gen10_plus_A100-SXM-40GB-MIG_{}x1g.5gb", KnownCPU.AMD_EPYC_7742.value,
            KnownMIG.A100_SXM_40GB_1GPC.value, [1], Memory(1, ByteSuffix.TiB))
add_systems("A100_SXM_80GB_MIG_{}x1g_10gb", "Apollo_6500_gen10_plus_A100-SXM-80GB-MIG_{}x1g.10gb", MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.AMD_EPYC_7763.value]),
            KnownMIG.A100_SXM_80GB_1GPC.value, [1], Memory(quantity=1.056291016, byte_suffix=ByteSuffix.TB))
...
# A10 in Apollo 6500 gen10+
add_systems("A10x{}", "Apollo_6500_gen10_plus_A10x{}",
            MatchAllowList([KnownCPU.AMD_EPYC_7742.value, KnownCPU.x86_64_Generic.value]),
            KnownGPU.A10.value, [1, 4, 8, 16], Memory(2, ByteSuffix.TB))

# add_systems("A10x{}", "Apollo_6500_gen10_plus_A10x{}",
#             KnownCPU.AMD_EPYC_7543.value,
#             KnownGPU.A10.value, [16], Memory(1, ByteSuffix.TiB))
...
add_systems("A100_SXM_80GB_RO_MIG_{}x1g_10gb", "DGX-Station-A100_A100-SXM-80GB-MIG_{}x1g.10gb",
            ...
            target_dict=_deprecated_systems)
add_systems("A100_SXM_40GB_MIG_{}x1g_5gb", "Apollo_6500_gen10_plus_A100-SXM-40GB-MIG_{}x1g.5gb",
            KnownCPU.AMD_EPYC_7742.value,
            KnownMIG.A100_SXM_40GB_1GPC.value, [56], Memory(1, ByteSuffix.TiB),
            target_dict=_deprecated_systems)
add_systems("A100_SXM_80GB_MIG_{}x1g_10gb", "Apollo_6500_gen10_plus_A100-SXM-80GB-MIG_{}x1g.10gb",
            KnownCPU.AMD_EPYC_7742.value,
...
class SystemClassifications:
    ...
    def start_from_device_enabled(cls, sys):
        return sys in [
            ...
            KnownSystem.A100_SXM_40GBx1,
            KnownSystem.A100_SXM_40GBx4,
            KnownSystem.A100_SXM_40GBx8,
            KnownSystem.A100_SXM_40GB_MIG_1x1g_5gb,
