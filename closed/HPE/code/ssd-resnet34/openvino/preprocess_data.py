...
def preprocess_coco_for_ssdresnet34(data_dir, preprocessed_data_dir, formats, overwrite=False):
    def loader(file):
...
def main():
    ...
    preprocess_coco_for_ssdresnet34(data_dir, preprocessed_data_dir, formats, overwrite)
