...
class A100_PCIe_40GBx10(A100_PCIe_40GBx1):
    ...
    gpu_inference_streams = 1
    gpu_copy_streams = 1
    #numa_config = "9:40-47,104-111&8:40-47,104-111&7:40-47,104-111&6:56-63,120-127&5:56-63,120-127&4:8-15,72-79&3:8-15,72-79&2:24-31,88-95&1:24-31,88-95&0:24-31,88-95"
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_PCIe_40GBx10_HighAccuracy_Triton(A100_PCIe_40GBx10_Triton):
    pass
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GB_MIG_1x1g5gb_HighAccuracy_Triton(A100_SXM_40GB_MIG_1x1g5gb_Triton):
    pass
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_40GBx4(A100_SXM_40GBx1):
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GBx1_HighAccuracy_Triton(A100_SXM_40GBx1_Triton):
    pass
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GBx8_HighAccuracy_Triton(A100_SXM_40GBx8_Triton):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxQ)
class A100_SXM_40GBx8_MaxQ(A100_SXM_40GBx8):
    power_limit = 225


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxQ)
class A100_SXM_40GBx8_HighAccuracy_MaxQ(A100_SXM_40GBx8_MaxQ):
    pass


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxQ)
class A100_SXM_40GBx8_Triton_MaxQ(A100_SXM_40GBx8_MaxQ):
    instance_group_count = 2
    use_triton = True


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxQ)
class A100_SXM_40GBx8_HighAccuracy_Triton_MaxQ(A100_SXM_40GBx8_Triton_MaxQ):
    pass
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A10x16_HighAccuracy(A10x16):
    pass
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A10x16_HighAccuracy_Triton(A10x16_Triton):
    pass
