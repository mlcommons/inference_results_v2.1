...
class A100_PCIe_40GBx1_HighAccuracy(A100_PCIe_40GBx1):
    precision = "fp16"
...
class A100_PCIe_40GBx1_Triton(A100_PCIe_40GBx1):
    use_triton = True
...
class A100_PCIe_40GBx1_TritonUnified(A100_PCIe_40GBx1):
    use_triton = True
    offline_expected_qps = 3000
...
class A100_PCIe_40GBx1_HighAccuracy_Triton(A100_PCIe_40GBx1_HighAccuracy):
    use_triton = True
...
class A100_PCIe_40GBx1_HighAccuracy_TritonUnified(A100_PCIe_40GBx1_HighAccuracy):
    use_triton = True
    offline_expected_qps = 1550
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_PCIe_40GBx10(A100_PCIe_40GBx1):
    system = KnownSystem.A100_PCIe_40GBx10
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_PCIe_40GBx10_HighAccuracy(A100_PCIe_40GBx10):
    precision = "fp16"
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_PCIe_40GBx10_Triton(A100_PCIe_40GBx10):
    use_triton = True
    offline_expected_qps = 33750
...
@ConfigRegistry.register(HarnessType.TritonUnified, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_PCIe_40GBx10_TritonUnified(A100_PCIe_40GBx10):
    use_triton = True
    offline_expected_qps = 33750
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_PCIe_40GBx10_HighAccuracy_Triton(A100_PCIe_40GBx10_HighAccuracy):
    use_triton = True
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GB_MIG_1x1g5gb_HighAccuracy(A100_SXM_40GB_MIG_1x1g5gb):
    precision = "fp16"
    gpu_batch_size = 64
    offline_expected_qps = 225
...
@ConfigRegistry.register(HarnessType.TritonUnified, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_40GB_MIG_1x1g5gb_TritonUnified(A100_SXM_40GB_MIG_1x1g5gb):
    use_triton = True


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GB_MIG_1x1g5gb_HighAccuracy_Triton(A100_SXM_40GB_MIG_1x1g5gb_HighAccuracy):
    use_triton = True
    gpu_batch_size = 32
    offline_expected_qps = 225
...
@ConfigRegistry.register(HarnessType.TritonUnified, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GB_MIG_1x1g5gb_HighAccuracy_TritonUnified(A100_SXM_40GB_MIG_1x1g5gb_HighAccuracy):
    use_triton = True
    gpu_batch_size = 32
    offline_expected_qps = 225
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GBx1_HighAccuracy(A100_SXM_40GBx1):
    precision = "fp16"
    offline_expected_qps = 1750
...
@ConfigRegistry.register(HarnessType.TritonUnified, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_40GBx1_TritonUnified(A100_SXM_40GBx1):
    use_triton = True


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GBx1_HighAccuracy_Triton(A100_SXM_40GBx1_HighAccuracy):
    use_triton = True


@ConfigRegistry.register(HarnessType.TritonUnified, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GBx1_HighAccuracy_TritonUnified(A100_SXM_40GBx1_HighAccuracy):
    use_triton = True


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_40GBx8(A100_SXM_40GBx1):
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GBx8_HighAccuracy(A100_SXM_40GBx8):
    precision = "fp16"
    gpu_batch_size = 1024
    offline_expected_qps = 15000
...
@ConfigRegistry.register(HarnessType.TritonUnified, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_40GBx8_TritonUnified(A100_SXM_40GBx8):
    use_triton = True


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GBx8_HighAccuracy_Triton(A100_SXM_40GBx8_HighAccuracy):
    use_triton = True


@ConfigRegistry.register(HarnessType.TritonUnified, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GBx8_HighAccuracy_TritonUnified(A100_SXM_40GBx8_HighAccuracy):
    use_triton = True
