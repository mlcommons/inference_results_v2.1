...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_40GB_MIG_1x1g5gb(SingleStreamGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.TritonUnified, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GB_MIG_1x1g5gb_HighAccuracy_TritonUnified(A100_SXM_40GB_MIG_1x1g5gb_Triton):
    precision = "fp16"


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_40GBx1(SingleStreamGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.TritonUnified, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class A100_SXM_40GBx1_HighAccuracy_TritonUnified(A100_SXM_40GBx1_Triton):
    precision = "fp16"
