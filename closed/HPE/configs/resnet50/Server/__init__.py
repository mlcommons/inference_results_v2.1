...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_PCIe_40GBx10(ServerGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_40GBx4(ServerGPUBaseConfig):
    system = KnownSystem.A100_SXM_40GBx4
    use_deque_limit = True
    deque_timeout_usec = 4000
    gpu_batch_size = 96 #16
    gpu_copy_streams = 4
    gpu_inference_streams = 3
...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_40GBx8(ServerGPUBaseConfig):
    system = KnownSystem.A100_SXM_40GBx8
    use_deque_limit = True
    deque_timeout_usec = 4000
    gpu_batch_size = 128 # 96 #128
    gpu_copy_streams = 4
    gpu_inference_streams = 3
    server_target_qps = 280000 # 300000
    start_from_device = True
    use_cuda_thread_per_device = True
    use_graphs = True
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class A100_SXM_80GBx8_Triton(A100_SXM_40GBx8):
    gpu_copy_streams = 1
    gpu_inference_streams = 2
    instance_group_count = 2
    batch_triton_requests = False
