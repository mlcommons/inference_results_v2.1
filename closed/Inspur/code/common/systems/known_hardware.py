...
class KnownCPU(MatchableEnum):
    ...
    AMD_EPYC_7713 = CPU(AliasedName("AMD EPYC 7713 64-Core Processor", ("AMD EPYC 7713",)),
                        CPUArchitecture.x86_64, 64, MatchAllowList([1, 2]))

    Intel_Xeon_Platinum_8358 = CPU(AliasedName("Intel(R) Xeon(R) Platinum 8358 CPU @ 2.60GHz"),
