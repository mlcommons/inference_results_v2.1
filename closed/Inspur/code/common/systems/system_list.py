...
add_systems("NF5468M6J_A100_PCIe_80GBx{}", "NF5468M6J_A100-PCIe-80GBx{}",
            MatchAllowList([KnownCPU.Intel_Xeon_Platinum_8380.value]),
            KnownGPU.A100_PCIe_80GB.value, [12, 16, 24], Memory(30, ByteSuffix.GiB))

add_systems("NE5260M5_A100_PCIe_80GBx{}", "NE5260M5_A100-PCIe-80GBx{}",
            MatchAllowList([KnownCPU.Intel_Xeon_Gold_6258R.value]),
            KnownGPU.A100_PCIe_80GB.value, [2], Memory(30, ByteSuffix.GiB))
...
add_systems("NF5488A5_A100_SXM_80GBx{}", "NF5488A5_A100-SXM-80GBx{}",
            MatchAllowList([KnownCPU.AMD_EPYC_7713.value]),
            KnownGPU.A100_SXM_80GB_500.value, [1, 8], Memory(30, ByteSuffix.GiB))
add_systems("NF5688M6_A100_SXM_80GBx{}", "NF5688M6_A100-SXM-80GBx{}",
            MatchAllowList([KnownCPU.Intel_Xeon_Platinum_8358.value]),
            KnownGPU.A100_SXM_80GB_500.value, [1, 8], Memory(30, ByteSuffix.GiB))
...
_system_confs["Triton_CPU_2S_6258R"] = SystemConfiguration(
...
class SystemClassifications:
    ...
    def start_from_device_enabled(cls, sys):
        return sys in [
            ...
            KnownSystem.NF5488A5_A100_SXM_80GBx1,
            KnownSystem.NF5488A5_A100_SXM_80GBx8,
            KnownSystem.NF5688M6_A100_SXM_80GBx1,
            KnownSystem.NF5688M6_A100_SXM_80GBx8,
