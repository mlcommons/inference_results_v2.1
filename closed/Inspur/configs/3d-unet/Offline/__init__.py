...
# edge ***
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NE5260M5_A100_PCIe_80GBx2(OfflineGPUBaseConfig):
    system = KnownSystem.NE5260M5_A100_PCIe_80GBx2
    gpu_batch_size = 1
    offline_expected_qps = 6
    numa_config = "0:0-27,56-83&1:28-55,84-111"

@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NE5260M5_A100_PCIe_80GBx2_HighAccuracy(NE5260M5_A100_PCIe_80GBx2):
    pass

@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NE5260M5_A100_PCIe_80GBx2_Triton(NE5260M5_A100_PCIe_80GBx2):
    use_triton = True
    output_pinned_memory = False


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NE5260M5_A100_PCIe_80GBx2_HighAccuracy_Triton(NE5260M5_A100_PCIe_80GBx2_Triton):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxQ)
class NE5260M5_A100_PCIe_80GBx2_MaxQ(NE5260M5_A100_PCIe_80GBx2):
    offline_expected_qps = 5


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxQ)
class NE5260M5_A100_PCIe_80GBx2_HighAccuracy_MaxQ(NE5260M5_A100_PCIe_80GBx2_MaxQ):
    pass


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxQ)
class NE5260M5_A100_PCIe_80GBx2_Triton_MaxQ(NE5260M5_A100_PCIe_80GBx2_Triton):
    offline_expected_qps = 5


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxQ)
class NE5260M5_A100_PCIe_80GBx2_HighAccuracy_Triton_MaxQ(NE5260M5_A100_PCIe_80GBx2_Triton_MaxQ):
    pass
# ***

@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx24(A100_PCIe_80GBx1):
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx24_Triton(NF5468M6J_A100_PCIe_80GBx24):
    use_triton = True
    output_pinned_memory = False


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx24_HighAccuracy(NF5468M6J_A100_PCIe_80GBx24):
    pass


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx24_HighAccuracy_Triton(NF5468M6J_A100_PCIe_80GBx24_Triton):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx1(OfflineGPUBaseConfig):
    system = KnownSystem.NF5688M6_A100_SXM_80GBx1
    gpu_batch_size = 1
    offline_expected_qps = 3
    start_from_device = True
    end_on_device = True
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx1_HighAccuracy(NF5688M6_A100_SXM_80GBx1):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx8(NF5688M6_A100_SXM_80GBx1):
    system = KnownSystem.NF5688M6_A100_SXM_80GBx8
    offline_expected_qps = 25


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx8_HighAccuracy(NF5688M6_A100_SXM_80GBx8):
    pass


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx8_Triton(NF5688M6_A100_SXM_80GBx8):
    use_graphs = True
    instance_group_count = 4
    use_triton = True
    output_pinned_memory = False
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx8_HighAccuracy_Triton(NF5688M6_A100_SXM_80GBx8_Triton):
    pass

@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx1_Triton(NF5688M6_A100_SXM_80GBx1):
    instance_group_count = 1
    gpu_inference_streams = 1
    gpu_copy_streams = 2
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx1_HighAccuracy_Triton(NF5688M6_A100_SXM_80GBx1_Triton):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx1(OfflineGPUBaseConfig):
    system = KnownSystem.NF5488A5_A100_SXM_80GBx1
    gpu_batch_size = 1
    offline_expected_qps = 3
    start_from_device = True
    end_on_device = True
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx1_HighAccuracy(NF5488A5_A100_SXM_80GBx1):
    pass



@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx1_Triton(NF5488A5_A100_SXM_80GBx1):
    instance_group_count = 1
    gpu_inference_streams = 1
    gpu_copy_streams = 2
    offline_expected_qps = 190
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx1_HighAccuracy_Triton(NF5488A5_A100_SXM_80GBx1_Triton):
    pass

@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx8(NF5488A5_A100_SXM_80GBx1):
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx8_Triton(NF5488A5_A100_SXM_80GBx8):
    use_graphs = True
    instance_group_count = 4
    use_triton = True
    output_pinned_memory = False
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx8_HighAccuracy(NF5488A5_A100_SXM_80GBx8):
    pass


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx8_HighAccuracy_Triton(NF5488A5_A100_SXM_80GBx8_Triton):
    pass
