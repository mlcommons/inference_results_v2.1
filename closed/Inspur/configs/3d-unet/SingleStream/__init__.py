...
# edge ***
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NE5260M5_A100_PCIe_80GBx2(SingleStreamGPUBaseConfig):
    system = KnownSystem.NE5260M5_A100_PCIe_80GBx2
    gpu_batch_size = 1
    single_stream_expected_latency_ns = 570000000
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx1(SingleStreamGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx1(SingleStreamGPUBaseConfig):
    system = KnownSystem.NF5688M6_A100_SXM_80GBx1
    gpu_batch_size = 1
    start_from_device = True
    end_on_device = True
    single_stream_expected_latency_ns = 600000000
