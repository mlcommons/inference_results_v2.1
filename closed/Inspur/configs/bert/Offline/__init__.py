...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx24_HighAccuracy_Triton(NF5468M6J_A100_PCIe_80GBx24_HighAccuracy):
    use_triton = True
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx1_HighAccuracy_Triton(NF5688M6_A100_SXM_80GBx1_HighAccuracy):
    use_triton = True
    gpu_batch_size = 1280
    gpu_copy_streams = 4
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx8_HighAccuracy_Triton(NF5688M6_A100_SXM_80GBx8):
    use_triton = True
    offline_expected_qps = 29500
    workspace_size = 7516192768
    batch_triton_requests = False


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx8_HighAccuracy_Triton(NF5688M6_A100_SXM_80GBx8_HighAccuracy):
    use_triton = True
    gpu_batch_size = 1280
    gpu_inference_streams = 1
    offline_expected_qps = 15000
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx1_HighAccuracy_Triton(NF5488A5_A100_SXM_80GBx1_HighAccuracy):
    use_triton = True
    gpu_batch_size = 1280
    gpu_copy_streams = 4
    instance_group_count = 1
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx8_HighAccuracy_Triton(NF5488A5_A100_SXM_80GBx8_HighAccuracy):
    use_triton = True
    gpu_batch_size = 1280
    gpu_inference_streams = 1
    offline_expected_qps = 15000
