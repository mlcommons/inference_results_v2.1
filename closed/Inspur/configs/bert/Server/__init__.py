...
class NF5688M6_A100_SXM_80GBx8(ServerGPUBaseConfig):
    ...
    graphs_max_seqlen = 240
    server_num_issue_query_threads = 0
    server_target_qps = 27400
    deque_timeout_usec = 5000
    soft_drop = 0.99
...
class NF5688M6_A100_SXM_80GBx8_HighAccuracy(NF5688M6_A100_SXM_80GBx8):
    ...
    precision = "fp16"
    server_target_qps = 13400
    deque_timeout_usec = 2500
