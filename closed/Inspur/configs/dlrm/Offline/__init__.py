...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx12(A100_PCIe_80GBx1):
    system = KnownSystem.NF5468M6J_A100_PCIe_80GBx12
    gpu_batch_size = 334000
    gpu_copy_streams = 4
    gpu_inference_streams = 1
    run_infer_on_copy_streams = False
    offline_expected_qps = 3000000
    numa_config = "0,1,2,3,4,5:0-39,80-119&6,7,8,9,10,11:40-79,120-159"

@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx12_HighAccuracy(NF5468M6J_A100_PCIe_80GBx12):
    pass

@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx12_Triton(NF5468M6J_A100_PCIe_80GBx12):
    offline_expected_qps = 3000000
    batch_triton_requests = True
    buffer_manager_thread_count = 0
    gpu_batch_size = 334000
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99_9, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx12_HighAccuracy_Triton(NF5468M6J_A100_PCIe_80GBx12_Triton):
    pass


@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx8(OfflineGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.Custom, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx8(OfflineGPUBaseConfig):
    system = KnownSystem.NF5688M6_A100_SXM_80GBx8
    complete_threads = 1
    gemm_plugin_fairshare_cache_size = 18
    gpu_batch_size = 409600
    gpu_copy_streams = 1
    gpu_inference_streams = 1
    run_infer_on_copy_streams = True
    offline_expected_qps = 2570000
    max_pairs_per_staging_thread = 262100
    start_from_device = True
    use_jemalloc = True
