...
class NF5688M6_A100_SXM_80GBx8(ServerGPUBaseConfig):
    ...
    gpu_num_bundles = 2
    deque_timeout_usec = 2
    server_target_qps = 2610000
    start_from_device = True
    use_jemalloc = True
    use_small_tile_gemm_plugin = True
    gemm_plugin_fairshare_cache_size = 18
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx8_Triton(ServerGPUBaseConfig):
    system = KnownSystem.NF5688M6_A100_SXM_80GBx8
    gpu_batch_size = 196608
    gpu_copy_streams = 4
    gpu_inference_streams = 1
    gpu_num_bundles = 2
    server_target_qps = 2000000
...
@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx8_Triton(ServerGPUBaseConfig):
    system = KnownSystem.NF5488A5_A100_SXM_80GBx8
    gpu_batch_size = 262100
    gpu_num_bundles = 2
    server_target_qps = 725000
