...
# edge ***
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NE5260M5_A100_PCIe_80GBx2(MultiStreamGPUBaseConfig):
...
class NE5260M5_A100_PCIe_80GBx2_MaxQ(NE5260M5_A100_PCIe_80GBx2):
    ...
    run_infer_on_copy_streams = False
    use_graphs = True
    multi_stream_expected_latency_ns = 630000
...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx1(MultiStreamGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx1(MultiStreamGPUBaseConfig):
    system = KnownSystem.NF5688M6_A100_SXM_80GBx1
    start_from_device = True
    multi_stream_expected_latency_ns = 650000
