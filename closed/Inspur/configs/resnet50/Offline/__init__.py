...
class NE5260M5_A100_PCIe_80GBx2_Triton_MaxQ(NE5260M5_A100_PCIe_80GBx2_Triton):
    offline_expected_qps = 70000.0
# ***
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx16(A100_PCIe_80GBx1):
    system = KnownSystem.NF5468M6J_A100_PCIe_80GBx16
    gpu_batch_size = 2048
    offline_expected_qps = 630000.0
    gpu_copy_streams = 4
    gpu_inference_streams = 1
    run_infer_on_copy_streams = False
    use_graphs = False
    numa_config = "0,1,2,3,4,5,6,7:0-39,80-119&8,9,10,11,12,13,14,15:40-79,120-159"

@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx24(A100_PCIe_80GBx1):
    system = KnownSystem.NF5468M6J_A100_PCIe_80GBx24
    gpu_batch_size = 2048
    offline_expected_qps = 670000.0
    gpu_copy_streams = 3
    gpu_inference_streams = 1
    run_infer_on_copy_streams = False
    use_graphs = False
