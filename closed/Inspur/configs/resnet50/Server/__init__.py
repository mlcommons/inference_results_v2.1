...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5468M6J_A100_PCIe_80GBx16(ServerGPUBaseConfig):
...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5488A5_A100_SXM_80GBx1(ServerGPUBaseConfig):
    system = KnownSystem.NF5488A5_A100_SXM_80GBx1
    use_deque_limit = True
    deque_timeout_usec = 800
    gpu_batch_size = 64
    gpu_copy_streams = 4
...
@ConfigRegistry.register(HarnessType.LWIS, AccuracyTarget.k_99, PowerSetting.MaxP)
class NF5688M6_A100_SXM_80GBx1(ServerGPUBaseConfig):
