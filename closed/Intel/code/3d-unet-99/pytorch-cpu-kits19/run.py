...
class Consumer(mp.Process):
    ...
    def do_warmup(self):
        ...
        log.info("Starting warmup with {} samples".format(len(warmup_data)))
...
#        issue_queries, flush_queries, process_latencies)
    ...
    qsl = lg.ConstructQSL(
        dataset_params['total_sample_count'], max(dataset_params['total_sample_count'], settings.performance_sample_count_override), load_query_samples, unload_query_samples)
