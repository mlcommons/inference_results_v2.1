...
mkdir ${OUTDIR}
CONFIG="-n 14 -j 8 --test_scenario=${mode} --model_file=${sut_dir}/bert.pt --sample_file=${sut_dir}/squad.pt --mlperf_config=${sut_dir}/inference/mlperf.conf --user_config=${sut_dir}/user.conf -o ${OUTDIR} -w 1290 ${accuracy}"
