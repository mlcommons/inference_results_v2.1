...
class BackendPytorchNative(backend.Backend):
    def __init__(self, m_spa, ln_emb, ln_bot, ln_top, device, use_gpu=False, use_ipex=False, use_bf16=False, use_int8=False, mini_batch_size=1, random_init=False):
    ...
    def load(self, model_path, inputs=None, outputs=None):
        ...
        if self.use_ipex:
            dlrm = model_util(dlrm, self.use_bf16, self.use_int8, self.device)
        self.model = dlrm
...
def get_backend(backend, dataset, device, max_ind_range, data_sub_sample_rate, use_gpu, use_ipex, use_bf16, use_int8):
