...
/**
 * rn50_backbone_bs9
 * @param backbone_output output tensor, [s8 [9, 2048, 7, 7] @ ACDB], real dims is [9, 7, 7, 2048]
 * @param backbone_input input tensor, [s8 [9, 64, 56, 56] @ ACDB], real dims is [9, 56, 56, 64]
...
/**
 * rn50_backbone_bs2
 * @param backbone_output output tensor, [s8 [2, 2048, 7, 7] @ ACDB], real dims is [2, 7, 7, 2048]
 * @param backbone_input input tensor, [s8 [2, 64, 56, 56] @ ACDB], real dims is [2, 56, 56, 64]
 * @param res2a_weight_b input tensor, [f32 [256, 64, 1, 1] @ ABCD]
 * @param res2a_bias_b input tensor, [f32 [256] @ A]
 * @param res2a_weight_0 input tensor, [f32 [64, 64, 1, 1] @ ABCD]
 * @param res2a_bias_0 input tensor, [f32 [64] @ A]
