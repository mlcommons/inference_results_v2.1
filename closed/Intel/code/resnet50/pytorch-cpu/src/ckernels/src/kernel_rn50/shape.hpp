...
inline const std::array<int, 4>& backbone_input() {
    static const std::array<int, 4> shape = {9,56,56,64};
    return shape;
}

inline const std::array<int, 4>& backbone_output() {
    static const std::array<int, 4> shape = {9,7,7,2048};
    return shape;
}
...
inline const std::array<int, 4>& backbone_input() {
    static const std::array<int, 4> shape = {2,56,56,64};
    return shape;
}

inline const std::array<int, 4>& backbone_output() {
    static const std::array<int, 4> shape = {2,7,7,2048};
    return shape;
}
