...
// Slicing kernel from FP32 LINEAR sample input to FP32 LINEAR Sliding Window input
void UNet3DKiTS19SliceKernelFP32Linear_wrapper(void* d_in, void* d_out, const UNet3DParams* p,
                                               const cudaStream_t stream, const int deviceId);
...
// Slicing kernel from INT8 LINEAR sample input to
// INT8 NC/32DHW32, 32Ch zero-padded, Sliding Window input
...
// and then accumulates the output to proper location to input sample sized FP16 3ch ouptut
