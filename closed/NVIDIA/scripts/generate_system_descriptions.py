...
IPP1_2469 = Machine(
    ...
    hw_notes="GPU and both DLAs are used in resnet50, in Offline scenario",
    sw_notes="",
    system_id_prefix="",
...
# The hopper preview node used for v2.1 maxP submission
# This node is the Lab02 h100 node.
HOPPER_SXM_01 = Machine(
    ...
    sw_notes="",
    system_id_prefix="",
    system_name_prefix="NVIDIA H100",
)

# The hopper preview node used for v2.1 maxP submission
# This node is the ComputeLab H100 node.
HOPPER_SXM_02 = Machine(
    status=Status.PREVIEW,
    ...
    accelerator_short_name="H100-SXM-80GB-02",
    mig_short_name="",
    accelerator_memory_capacity="80 GB",
    accelerator_memory_configuration="HBM3",
    hw_notes="",
...
submission_systems = [
    ...
    System(HOPPER_SXM_01, Division.CLOSED, SystemType.DATACENTER, 1, 0, False, False),  # H100-SXM-80GBx1-maxP
    System(HOPPER_SXM_02, Division.CLOSED, SystemType.DATACENTER, 1, 0, False, False),  # H100-SXM-80GBx1-maxP
