...
G_BENCHMARK_CLASS_MAP = {
    ...
    Benchmark.SSDResNet34: ModuleLocation("code.ssd-resnet34.tensorrt.SSDResNet34", "SSDResNet34"),
    Benchmark.SSDMobileNet: ModuleLocation("code.ssd-mobilenet.tensorrt.SSDMobileNet", "SSDMobileNet"),
...
G_HARNESS_CLASS_MAP = {
    ...
    "bert_harness": ModuleLocation("code.bert.tensorrt.harness", "BertHarnessVodla"),
