...
class A30X4(SingleStreamGPUBaseConfig):
    system = KnownSystem.A30x4
...
class A30X4_HighAccuracy(A30X4):
    precision = "fp16"
    single_stream_expected_latency_ns = A30X4.single_stream_expected_latency_ns * 2


@ConfigRegistry.register(HarnessType.Triton, AccuracyTarget.k_99, PowerSetting.MaxP)
class A30X4_Triton(A30X4):
    use_triton = True
...
class A30X4_HighAccuracy_Triton(A30X4_HighAccuracy):
    use_triton = True
